...
class ToMongo:
    ...
    def __init__(self, dbclint=None):
        ...
        # self.myclient = pymongo.MongoClient(host="192.168.24.117", port=27017)
        # self.myclient = pymongo.MongoClient(host="192.168.24.198", port=27017)
    ...
    def query_collection_count_by_field(self, col, query):
        '''
        多条件查询表数据
        :param col: 表名
        :param query: 查询条件
        :return:
        '''
        return self.mydb[col].find(query)
