...
def insert_camera_advise(my_db, camera_name, flag, organization_id):
    ...
    content1 = "<div class='notice-container'><a class='notice-reson' href='#'>" + camera_name + "</a><p class='notice-desc'><b>状态描述：</b>摄像机重新上线。 </p><s class='bottom-line'></s><p class='notice-date'>" + \
               res['birth_time'] + "</p></div>"
    content2 = "<div class='notice-container'><a class='notice-reson' href='#'>" + camera_name + "</a><p class='notice-desc'><b>状态描述：</b>系统无法检测到摄像机。 </p ><p class='notice-plan'><s class='notice-dashed-line'></s><b>解决方案：</b> 请检查网络是否正常连接，代理模块、摄像机是否处于正常运行状态。 </p ><s class='bottom-line'></s><p class='notice-date'>" + \
               res['birth_time'] + "</p ></div>"
    if flag == 0:
